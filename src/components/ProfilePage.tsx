...
import { User, RefreshCw, Volume2, VolumeX, ShieldCheck, ArrowLeft, Check, Wallet, Award, Activity, Settings, Bell, Sliders, LogOut, ShieldAlert, Smartphone, Gift } from 'lucide-react';
    ...
    <div className="flex-1 flex flex-col bg-[#0B0E11] text-gray-200 overflow-hidden w-full h-full">
      ...
      <div className="flex-1 overflow-y-auto p-4 sm:p-6 max-w-5xl w-full mx-auto space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
          ...
          <div className="bg-[#0F1419] p-5 rounded-2xl border border-gray-800 shadow-md flex flex-col justify-between">
            ...
            <div className="grid grid-cols-2 gap-3 p-1.5 bg-gray-900 rounded-xl border border-gray-800">
              <button
                ...
                className={cn(
                  "py-3 px-3 rounded-xl text-xs font-bold transition flex items-center justify-center space-x-2 cursor-pointer",
          ...
          {/* Quick Demo Fund Refill */}
          <div className="bg-[#0F1419] p-5 rounded-2xl border border-gray-800 shadow-md flex flex-col justify-between">
            <div>
              <div className="flex items-center justify-between mb-2">
                <span className="text-xs text-gray-400 uppercase font-bold tracking-wider">Active Demo Balance</span>
                <span className="text-xs bg-blue-500/20 text-blue-400 px-2 py-0.5 rounded-md font-mono font-bold">Refillable</span>
              </div>
              <div className="text-2xl sm:text-3xl font-black text-green-400 my-2">
                ${balance.toLocaleString(undefined, { minimumFractionDigits: 2 })}
              </div>
              <p className="text-xs text-gray-400 mb-4">
                Practice trading safely with $10,000 virtual balance. Reset anytime if your balance runs low.
              </p>
            </div>
            ...
            <div className="space-y-2">
              <button
                onClick={handleReset}
                className={cn(
                  "w-full py-3 rounded-xl text-xs sm:text-sm font-bold transition flex items-center justify-center space-x-2 shadow-lg active:scale-95 cursor-pointer",
                  resetSuccess 
              ...
              >
                {resetSuccess ? (
                  ...
                  <>
                    ...
                    <span>Refill Demo Account ($10,000)</span>
                  </>
                )}
              </button>
